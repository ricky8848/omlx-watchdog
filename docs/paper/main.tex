...
\begin{titlepage}
  ...
  \begin{tabular}{rl}
    ...
    License:    & MIT \\[0.3em]
    Artifact:   & \url{https://github.com/ricky8848/omlx-watchdog} (v9.1)\\[0.3em]
    DOI:        & \url{https://doi.org/10.5281/zenodo.22675074}\\[0.3em]
    Zenodo:     & \url{https://zenodo.org/records/22675074}
  \end{tabular}\\[2em]
...
B(t) &: \big(\texttt{loaded\_models} = \varnothing\big) \lor \big(\exists m{:}\; m.\texttt{registered}\big) \\[0.3em]
...
\noindent\textbf{Empty-registry awareness (F4 fix).} After a model switch the registry may transiently be empty; $B(t)$ treats $\varnothing$ as healthy rather than triggering a restart storm (79 such events in the v5 era).
...
Watchdog + installer: \url{https://github.com/ricky8848/omlx-watchdog} (MIT, v9.1; \texttt{curl | bash}). Three-layer config: \url{https://github.com/ricky8848/mac-m5-128g-omlx-settings}. Full de-identified trace: \texttt{docs/paper/production-data.json} in the artifact repository. Technical report (EN): \url{https://doi.org/10.5281/zenodo.22675074} (Zenodo).
